...
void Display::initGpios() {
	...
	for (int i = DISPLAY_DATA_BASE; i < DISPLAY_DATA_BASE + DISPLAY_DATA_LEN;
		...
		data_bit_[i].setGpioPath("/sys/class/gpio");
		data_bit_[i].exportPin();
